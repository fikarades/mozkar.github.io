<?php
 if(isset($_GET["bl"])){
    ...
    $th =$_GET["th"];
        ...
        header("Content-Disposition:attachment; filename=penerimaan_$bl_$th.xls");
...
<body>
   ...
   if(isset($_GET["bl"])){
    ...
    <tr> 
        <td colspan="11"><br>A. STOK AWAL BULAN ( Tgl 1 pagi sebelum penjualan )</td>
    </tr>
    <tr> 
        <td>PREMIUM</td>
        <td>: </td>
    ...
    <tr>
    <td  colspan="11"> <br>B1. PENERIMAAN DARI PT. PERTAMINA (PERSERO) DALAM KL </td>
    </tr>
    </table>
